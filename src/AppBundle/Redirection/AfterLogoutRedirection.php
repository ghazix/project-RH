...
class AfterLogoutRedirection implements LogoutSuccessHandlerInterface
{
    ...
    public function onLogoutSuccess(Request $request)
    {
        ...
        if (in_array('ROLE_ADMIN', $rolesTab, true) || in_array('ROLE_SENIOR', $rolesTab, true) || in_array('ROLE_MANAGER', $rolesTab, true)
            || in_array('ROLE_ASSISTANT', $rolesTab, true))
            $response = new RedirectResponse($this->router->generate('infosUser_page'));
